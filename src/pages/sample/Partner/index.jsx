...
const Index = () => {
  ...
  const {
    ...
    isLoading: getCategoryLoading,
      refetch
  } = useQuery('partner-get', () => apiService.getData('/about/partner'), {
    // enabled:false,
    onError: (error) => {
  ...
  const serachProduct = (value) => {
    ...
    const filterData = data?.filter(
      (data) =>
        data.full_name_uz.toLowerCase().includes(value.toLowerCase()) ||
        data.full_name_ru.toLowerCase().includes(value.toLowerCase()),
    );
